...
public class LinqSamples
{
	...
	[Description(@"This sample uses First to return the first matching element
				   as a Product, instead of a sequence conatining a Product.")]
	public void Sample58()
	{
		...
		// products.Where(x => x.ProductID == 12).First().Dump();
	...
	[Description(@"This sample uses FirstOrDefault to try to return the first element of the sequence,
				   ...
				   FirstOrDefault is useful for creating outer joins.")]
	public void Sample61()
	{
		int[] numbers = {};
