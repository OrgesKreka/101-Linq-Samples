...
public class LinqSamples
{
	...
	public void Sample28()
	{
		...
		// version using extended method
		words.OrderBy(w => w).Dump();
	...
	[Description(@"This sample uses orderby to sort a list of products by name.
				   Use descending keyword at the end of the clause to perform a reverse ordering.")]
	public void Sample30()
	{
		...
		// extended method
		//products.OrderBy(x => x.ProductName).Dump("Extended method");
		sortedProducts.Dump();
	}
	...
	public void Sample31()
	{
		...
		var sortedWords = words.OrderBy( x => x, new CaseInsensitiveComparer());
	...
	public void Sample32()
	{
		...
		// extended method
		//doubles.OrderByDescending(x => x).Dump();
	...
	[Category("Ordering Operators")]
	[Description(@"This sample uses order by to sort a list of products by units in stock
	...
	public void Sample33()
	{
		...
		//products.OrderByDescending( x => x.UnitsInStock).Dump();
		
		sortedProducts.Dump();
	}
	
	[Category("Ordering Operators")]
	[Description(@"This sample uses method syntax call OrderByDescending because it 
	...
	public void Sample35()
	{
		...
		// method syntax call
		//digits.OrderBy(x => x.Length).ThenBy(y => y).Dump();
	...
	[Category("Ordering Operators")]
	[Description(@"The first query in this sample uses method syntax call OrderBy and ThenBy with a custom comparer to
				   sort first word length and then by a case-insensitive sort of the words in an array.
	...
	public void Sample36()
	{
		...
		// Another way. TODO is this use of the ThenBy correct ? It seems to work on this sample array.
		var sortedWords2 = from word in words
						   orderby word.Length
						   select word;
		var sortedWords3 = sortedWords.ThenBy(a => a, new CaseInsensitiveComparer());
	...
	public void Sample37()
	{
		...
		// method syntax call
		//products.OrderBy(x => x.Category).OrderByDescending(x => x.UnitPrice).Dump();
	...
	[Category("Ordering Operators")]
	[Description(@"This sample uses Reverse to create a list of all digits in the array
	...
	public void Sample39()
	{
		...
		// method syntax
		//digits.Where(x => x[1] == 'i').Reverse().Dump();
		
		reversedIDigits.Dump();
	}
