...
public class LinqSamples
{
	...
	[Description(@"This sample uses Distinc to remove duplicate elements in a sequence of
				   factors of 300.")]
	...
	public void Sample47()
	{
		...
		//products.Select(x => x.Category).Distinct().Dump();
	...
	[Category("Set Operators")]
	[Description(@"This sample uses Union method to create one sequence that contains the unique first letter
	...
	[Description(@"This sample uses Except to create one sequence that contains the first letters
				   of product names that are also first letters of customer names.")]
