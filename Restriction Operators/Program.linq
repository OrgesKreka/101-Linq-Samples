...
void Main()
{
//	var examples = new RestrictionOperatorsSamples();
//	examples.Sample2();


	var type = typeof(RestrictionOperatorsSamples);
...
public class RestrictionOperatorsSamples
{
	...
	public void Sample1()
	{
		...
		*/
		...
		lowNums.ToList().ForEach( n => Console.WriteLine(n));	
	}
	
	[Description("This sample uses the where clause to find all the products that are out of stock. ")]
	public void Sample2()
	{
		...
		*/
		...
		soldOutProducts.ForEach(p => Console.WriteLine($"{p.ProductName} is sold out!"));
	}
	
	[Description("This sample uses the where clause to find all products that are in stock and costs more than 3.00 per unit"  )]
	public void Sample3()
	{
		var products = GetProductList();
		...
		*/
		...
		Console.WriteLine("In-stock products that costs more than 3.00: ");
		expensiveInStockProducts.ForEach(prod => Console.WriteLine($"{prod.ProductName} is in stoc and costs more than 3.00"));
	}
	
	
	[Description("This samples uses the where clause to find all customers in Washington and then it uses a foreach loop to iterate over the orders collection that belongs to each customer")]
	public void Linq4()
	{
	...
	[Description("This sample demonstrates an indexed where clause that returns digits whose name is shortet than their value.")]
	public void Linq5()
	{
...
//		
		...
		var shortDigits = (from d in digits
						 where d.Length < Array.IndexOf(digits, d)
						 select d).ToList();
		
		Console.WriteLine("Short digits: ");

		shortDigits.ForEach(digit => Console.WriteLine($"The word {digit} is shorter than its value" ));
	}
	...
	private void CreateLists()
	{
	 ...
	 _customerList = (from e in XDocument.Load(@"C:\Users\o.kreka\Documents\LINQPad Queries\101 LINQ Samples\Customers.xml")
